...
namespace DataAccessLayer.Ado
{
	...
	public class ExecutionLog3AdoDAL
    {
        
        private const string TableName = @"ExecutionLog3";
        ...
        public ExecutionLog3AdoDAL()
        {
			 _db = DatabaseFactory.CreateDatabase();
        }
		
		public ExecutionLog3AdoDAL(string connectionStringName)
        {
