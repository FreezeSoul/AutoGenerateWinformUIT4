...
namespace DataAccessLayer.Ado
{
	...
	public class ExecutionLog2AdoDAL
    {
        
        private const string TableName = @"ExecutionLog2";
        ...
        public ExecutionLog2AdoDAL()
        {
			 _db = DatabaseFactory.CreateDatabase();
        }
		
		public ExecutionLog2AdoDAL(string connectionStringName)
        {
