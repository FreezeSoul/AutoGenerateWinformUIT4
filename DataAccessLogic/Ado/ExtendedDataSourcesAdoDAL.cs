...
namespace DataAccessLayer.Ado
{
	...
	public class ExtendedDataSourcesAdoDAL
    {
        
        private const string TableName = @"ExtendedDataSources";
        ...
        public ExtendedDataSourcesAdoDAL()
        {
			 _db = DatabaseFactory.CreateDatabase();
        }
		
		public ExtendedDataSourcesAdoDAL(string connectionStringName)
        {
