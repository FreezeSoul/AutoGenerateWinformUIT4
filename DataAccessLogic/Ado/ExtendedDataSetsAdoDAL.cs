...
namespace DataAccessLayer.Ado
{
	...
	public class ExtendedDataSetsAdoDAL
    {
        
        private const string TableName = @"ExtendedDataSets";
        ...
        public ExtendedDataSetsAdoDAL()
        {
			 _db = DatabaseFactory.CreateDatabase();
        }
		
		public ExtendedDataSetsAdoDAL(string connectionStringName)
        {
